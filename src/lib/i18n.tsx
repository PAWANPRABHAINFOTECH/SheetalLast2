...
const translations: Record<Language, Record<string, string>> = {
  hi: {
    ...
    'nav.gallery': 'गैलरी',
    'nav.members': "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\\n                                        \\n                                            \\n                                            मोबाइल और डेस्कटॉप दोनों views में header को व्यवस्थित करें।\\n\\n1. Brand Name:\\n\\n\\\"शीतल शिवालय समिति\\\" हमेशा स्पष्ट और पूरा दिखाई देना चाहिए।\\n\\n2. Brand Name के ठीक नीचे दिया गया address:\\n\\n\\\"शीतल सिटी, मंडीदीप, जिला-रायसेन (मध्यप्रदेश)\\\"\\n\\nयह brand-name वाले container की उपलब्ध width के अंदर ही रहे।\\n\\nAddress किसी भी स्थिति में container से बाहर न निकले, कटे नहीं और दूसरे menu/social icons के ऊपर overlap न करे।\\n\\nजरूरत पड़ने पर font-size, line-height और spacing को responsive तरीके से थोड़ा छोटा करें, लेकिन text को छिपाएँ नहीं।\\n\\n3. Navigation Menu:\\n\\n\\\"होम\\\", \\\"मंदिर के बारे में\\\", \\\"लाइव दर्शन\\\", \\\"विशेष सूचना\\\", \\\"गैलरी\\\", \\\"पोस्टर\\\", \\\"संपर्क\\\"\\n\\nइन सभी navigation items को desktop पर एक ही horizontal line में व्यवस्थित रखें।\\n\\nकिसी भी menu item को दूसरी line में wrap न होने दें।\\n\\nMenu के बीच उचित spacing रखें और header के उपलब्ध स्थान के अनुसार responsive sizing करें।\\n\\n4. Desktop पर logo + brand section, navigation और right-side icons/buttons आपस में overlap नहीं होने चाहिए।\\n\\n5. Mobile view में existing hamburger menu व्यवस्था बनी रहे। Mobile पर desktop navigation को जबरदस्ती एक line में दिखाकर layout खराब न करें।\\n\\n6. Header की existing colors, logo, typography style और overall design को न बदलें।\\n\\nकेवल alignment, width, spacing, font-size और responsive layout ठीक करें।\\n\\n7. कोई अन्य section, image, slider, poster, video, donation window या content modify न करें।\\n\\nकेवल header layout की उपरोक्त समस्याएँ ठीक करें।",
    'nav.contact': 'संपर्क',
